...
friend class StateMachine;
 ...
 public:
     ...
     * @brief 创建根节点使用的构造函数
    */
    StateMachineState(const std::string& state_name, StateMachine* sm = nullptr);

    /**
     * @brief 创建子节点使用的构造函数
    */
    StateMachineState(const std::string& state_name, StateMachineState* const parent_state, StateMachine* sm = nullptr, StateMachineStateType state_type = StateMachineStateType::NornalState);
